...
public:
    ...
    int analogNb_hw;                        // Stores the number of physical analog inputs on the receiver.
    int digitalNb_hw;                       // Stores the number of physical digital inputs on the receiver.
    int analogPin[NB_MAX_DATA];             // Stores the pin number of the analog inputs.
    int digitalPin[NB_MAX_DATA];            // Stores the pin number of the digital inputs. When available, the Bluetooth state pin is the first index of the wired sensors.
    ...
    bool digitalState(int ii);         // Returns the state of the digital input at index ii.
    bool digitalFalling(int ii);       // True if digital input goes from HIGH to LOW. False if not.
    bool digitalRising(int ii);        // True if digital input goes from LOW to HIGH. False if not.
